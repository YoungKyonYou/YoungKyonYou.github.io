...
상문이가 피규어를 고를 때 보는 **기준들**은 아래와 같다.
...
당시 상문이는 **"나는 무언가를 끌어안고 자야 잘 수 있어"** 라며 매우 유심히, 실용성을 따져가며 여러 인형들을 이마트 안에서 끌어 안아보고 많은 시간을 들여 이 펭귄 인형을 선택했다. :expressionless: 정말 이해를 할 수 없었다.
