...
빠르게 이벤트를 만드는 방법은 해당 버튼을 클릭한 다음 enter 키를 누르게 되면 바로 click 이벤트 메서드가 생성되는 것을 알 수 있다. 

![](/images/eXbuilder6/2022-05-25-12-35-58.png?style=centerme)

![](/images/eXbuilder6/2022-05-25-12-36-06.png?style=centerme)

<br>

그리드 또한 클릭한 다음 enter를 누르게 되면 **selection change**라는 이벤트에 대한 메서드를 자동으로 생성해 주는 것을 알 수 있다. 

![](/images/eXbuilder6/2022-05-25-12-39-08.png?style=centerme)

![](/images/eXbuilder6/2022-05-25-12-39-15.png?style=centerme)

<br>

**Properties**의 **사용자 속성**은 eXBuilder6가 제공하는 속성이 아니라 사용자가 정의하는 속성을 사용할 때 사용한다.

![](/images/eXbuilder6/2022-05-25-12-47-19.png?style=centerme)

<br>

추가버튼을 클릭하여 컨트롤 사용자 속성을 추가할 수 있고 DOM 데이터 속성을 추가할 수 있다. 

![](/images/eXbuilder6/2022-05-25-12-47-55.png?style=centerme)

![](/images/eXbuilder6/2022-05-25-12-48-30.png?style=centerme)

<br>

**Properties의 Binding**은 외부에 있는 데이터를 가져와서 값을 보여줘야 하는데 속성들에 외부의 값을 가져온 후 매핑해준다 라고 생각하면 된다.


---

화면 하단의 Assist 탭에서는 5가지 하위 탭을 제공한다.

![](/images/eXbuilder6/2022-05-25-12-50-42.png?style=centerme)

<br>

일단 디자인 탭에서 **Root Container**를 클릭하고 **앱 주석**을 보면 이는 clx 파일에 대한 **설명**을 적을 수 있는 공간이다. 

먼저 앱주석에 <span style="background: rgb(251,243,219)">교육용 테스트 화면입니다.</span> 라는 글을 쓰고 앞에서 배웠던 **Ctrl+Shift+,** 눌러서 앱주석을 검색해보면 아래와 같은 결과를 볼 수 있다. 

![](/images/eXbuilder6/2022-05-25-12-51-58.png?style=centerme)

<br>

**Assist**의 **스타일 시트**는 스타일 파일 또는 외부 스크립트 파일을 추가하여 참조시킬 수 있다. 

![](/images/eXbuilder6/2022-05-25-12-53-21.png?style=centerme)

<br>

이 **edu01.clx**에서만 사용하는 스타일 시트가 있을 경우 아래 사진과 같이 자물쇠 모양을 클릭한다.

![](/images/eXbuilder6/2022-05-25-12-54-15.png?style=centerme)

<br>

지금은 현재 controls 파일에 **part.less** 파일들만 존재함으로 이 파일들만 나열이 되는 것이다. 여기서 만약에 특정 파일을 추가해서 만든 파일인데 이 clx 파일에서만 사용한다고 하면 여기 **스타일 시트**에 추가하면 되는 것이다. <span style="background: rgb(251,243,219)">반드시 소스경로(theme)에 있는 파일만 추가할 수 있다는 것을 기억해야 한다.</span>

![](/images/eXbuilder6/2022-05-25-12-54-49.png?style=centerme)

<br>

**Assist**의 **출판된 속성, 출판된 이벤트**는 UDC에 대해 설명할 때 이야기할 것이다. 이 **edu01.clx** 파일이 하나의 앱이고 이 앱을 다른 앱에서 불러와서 사용할 수 있다. 즉 부모 앱이 있고 그 부모 앱에서 이 edu01.clx 파일은 안에다가 임베디드 해가지고 사용할 수 있는데 이때 임베디드 된 앱의 속성이나 이벤트를 다른 앱에서 사용하고 싶을 때 출판을 해서 사용해야 되는 것이다.

<br>

오른쪽 상단에 **Outline** 뷰에서는 디자인 탭의 상황을 미리보기로 볼 수 있고 배치되어 있는 컨트롤을 조그만하게 볼 수 있다. 

![](/images/eXbuilder6/2022-05-25-13-00-57.png?style=centerme)

<br>

이때 배치된 순서를 바꾸고 싶으면 클릭후 Ctrl+(방향키 up) 를 하게 되면 순서가 바뀐다.

![](/images/eXbuilder6/2022-05-25-13-02-42.png?style=centerme)

<br>

아니면 오른쪽 클릭후 순서변경으로 바꿀 수도 있다.

![](/images/eXbuilder6/2022-05-25-13-03-27.png?style=centerme)

<br>

앞으로 가져올 것인지 뒤로 보낼 것인지 tab index를 지정해 줄 수 있는 것이다. 

![](/images/eXbuilder6/2022-05-25-13-04-01.png?style=centerme)

<br>

현재 컨트롤의 배치가 아래와 같다. 이제 미리보기를 클릭해 본다.

![](/images/eXbuilder6/2022-05-25-13-05-15.png?style=centerme)

<br>

가장 위 버튼을 누르면 그 아래 버튼으로 focus가 옮겨가고 두 번째 버튼을 누르면 그리드 쪽으로 focus가 가야하지만 그리드는 focus를 받을 수 없어서 focus가 나타나지 않는 것이다.(파란색 테두리) 

즉, <span style="background: rgb(251,243,219)">Outline 뷰의 순서대로 포커스가 이동하는 것을 볼 수 있다.</span>

![](/images/eXbuilder6/2022-05-25-13-05-47.png?style=centerme)

<br>

또한 **Outline** 뷰에서 **XY 레이아웃** 쪽에 **Comment** 부분에 **버튼1**이라고 적게 되면, 아래 그림과 같이 버튼에 마우스를 올려놨을 때 Comment에 적혀진 부분이 설명으로 뜨는 것을 볼 수 있다. 

![](/images/eXbuilder6/2022-05-25-13-07-51.png?style=centerme)

<br>

그리고 Outline View 쪽에 눈 모양에 체크를 하게 되면 해당하는 컨트롤이 안 보이게 된다. 중요한 것은 이상태에서 **미리보기 브라우저**를 누르게 되면 사라지지 않고 **표시**된다는 점이다

![](/images/eXbuilder6/2022-05-25-13-09-14.png?style=centerme)

![](/images/eXbuilder6/2022-05-25-13-11-22.png?style=centerme)

<br>

Outline View 쪽에 자물쇠 모양에 체크를 하게 되면 디자인 탭에서 해당 컨트롤을 선택할 수 없게 된다(드래그로 선택이 안됨)

![](/images/eXbuilder6/2022-05-25-13-09-53.png?style=centerme)